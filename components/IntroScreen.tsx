...
export default function IntroScreen({ progress, onStart }: IntroScreenProps) {
  return (
    <div className="fixed inset-0 z-50 w-full max-w-6xl mx-auto px-4 py-10 lg:grid lg:gap-4 lg:grid-cols-12 lg:pb-20 lg:pt-40">
      <div className="text-center relative z-10 mb-10 lg:col-span-5 lg:mb-0">
        <h1 className="text-3xl text-neutral-500 font-bold uppercase mb-8 lg:hidden">
      ...
      <div className="block space-y-10 text-center lg:col-span-7">
        <h1 className="hidden text-4xl text-neutral-500 font-bold uppercase mb-4 lg:block">
          Happy Holidays {new Date().getFullYear()}
        </h1>

        <p className="text-neutral-600 font-medium text-xl lg:text-2xl">
