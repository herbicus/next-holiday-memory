...
export default function EndScreen({ onRestart, visible = false }: EndScreenProps) {
  ...
  useEffect(() => {
    if (visible && !hasAnimated.current && containerRef.current && titleRef.current && messageRef.current && buttonRef.current) {
